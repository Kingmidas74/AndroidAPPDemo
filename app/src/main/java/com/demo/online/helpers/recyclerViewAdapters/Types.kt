...
@JvmOverloads constructor(layout: Int, variable: Int? = null) : AbsType<B>(layout, variable) {
    ...
    internal var onChildElementClick: Action<B>? = null; private set
    internal var onSwipe: ((Int) -> Unit)? = null; private set
    ...
    fun onChildElementClick(action: Action<B>?) = apply { onChildElementClick = action }
    fun onSwipe(action: ((Int) -> Unit)?) = apply { onSwipe = action }
}
